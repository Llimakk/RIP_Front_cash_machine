...
import {createBill} from "store/slices/billsSlice.ts";
import {T_BillAddData} from "modules/types.ts";
...
const BillAddPage = () => {
    ...
    const handleCreateBill = async() => {
        ...
        await dispatch(createBill(formData as T_BillAddData))
        ...
        <Container style={{marginTop:"5%"}}>
            <Row>
                ...
                <Col md={6}>
                    ...
                    <CustomInput type="number" label="Год выпуска" placeholder="Введите год выпуска" value={year} setValue={setYear} min={1}/>
                    ...
                    <Col className="d-flex justify-content-center gap-5 mt-5">
                        <Button color="success" className="fs-4" onClick={handleCreateBill}>Создать</Button>
                    </Col>
                </Col>
            </Row>
        </Container>
